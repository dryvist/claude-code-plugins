...
Git security and workflow protection via PreToolUse and UserPromptSubmit hooks.
...
- **worktree-reminder** — fires on every user prompt; if on the main branch, requires a worktree before any edits (where you create it is up to you)
