...
Use the "Recommended Prompt for Next Session", "Recommended GitHub Issues",
and "Session Issues Log" sections generated by `/session-status` in Step 0.
Format the output according to the standard layout provided by the
